export const bio = {
  ...
  mn: "Би техник хангамж, программ хангамжийн инженер бөгөөд C, JavaScript, Python хэлүүдээр олон систем бүтээсэн туршлагатай. Программ хангамжийн хувьд React, Next.js, Tkinter, Qt, Node.js, Flask зэрэг технологийг ашиглан компьютер, веб болон серверийн программууд бүтээж чадах бол техникийн хувьд микроконтроллер, микропроцессоруудыг програмчлах, тэдгээрийг электрон бүрэлдэхүүн хэсгүүдтэй уялдуулан нарийн төвөгтэй системүүдийг хөгжүүлэх чадамжтай. Иймд техник болон программ хангамжийг уялдуулан, орчин үеийн системүүдийг бүтээх хүсэл эрмэлзэлтэй.",
};
