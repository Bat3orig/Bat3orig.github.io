export const bio = {
  en: "As a Hardware and Software Engineer, I specializied in C, Javascript and Python. My development skills encompass desktop, web and backend applications, built with React, Next.js, Tkinter, Qt, Node.js and Flask. I am highly proficient in programming microcontrollers and microprocessors, seamlessly integrating them with electronic components to develop sophisticated systems. Driven by a passion for innovation, I create cutting-edge IoT systems by effectively bridging the gap between hardware and software.",
  mn: "Би техник хангамж, програм хангамжийн инженер бөгөөд C, JavaScript, Python хэлүүдээр олон систем бүтээсэн туршлагатай. Програм хангамжийн хувьд React, Next.js, Tkinter, Qt, Node.js, Flask зэрэг технологийг ашиглан компьютер, вэб болон серверийн програмууд бүтээж чадах бол техникийн хувьд микроконтроллер, микропроцессоруудыг програмчлах, тэдгээрийг электрон бүрэлдэхүүн хэсгүүдтэй уялдуулан нарийн төвөгтэй системүүдийг хөгжүүлэх чадамжтай. Иймд техник болон програм хангамжийг уялдуулан, орчин үеийн системүүдийг бүтээх хүсэл эрмэлзлэлтэй.",
};
...
export const works: { en: TWork[]; mn: TWork[] } = {
  ...
  mn: [
    ...
    },
    {
      ...
      year: "2022 - 2023",
      occupation: "Програм хангамжийн инженер",
      details: [
        {
          name: "Тоон гарын үсгийн бүртгэлийн програм хөгжүүлсэн",
          link: {
            href: "https://register.tridumkey.mn",
            text: "линк",
          },
    ...
    },
    {
      ...
      details: [
        ...
        {
          name: "Төмөр замын хаалтгүй гарамын төлөвийг зүтгүүр дотроос урьдчилан харах, газрын зурагт суурилсан хяналтын систем зохион бүтээсэн",
          link: {
            href: "https://incon-website-two.vercel.app/product/2",
            text: "Дэлгэрэнгүй",
          },
    ...
    },
    {
      ...
      details: [
        ...
        {
          name: "Уурхайд ашиглагддаг RFID tag - тай уутны цоожны мэдээллийг суулгаж өгдөг, хяналт болон бүртгэлийн программ бүхий төхөөрөмж хөгжүүлсэн. Энэхүү төхөөрөмж нь өгөгдсөн баркодын утгыг уншиж, цоож дотор байрлах tag - руу мэдээллийг суулгаж (шарах) өгдөг. Desktop програм нь үйлдвэрлэж байгаа цоожоо тоолох, хянах, бүртгэх, мэдээллийн сан үүсгэх боломжтой. Гранд Говь Теч ХХК нь 2017 онд RFID tag - д суурилсан уутны цоожны үйлдвэрлэлдээ үүнийг ашиглаж эхэлсэн ба гар ажиллагааг халж, үйлдвэрлэлийн явцыг хурдасгаж өгсөн",
          link: null,
        },
      ],
    },
